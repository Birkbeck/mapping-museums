...
# Preparation
db_source_fn = "mm_input_maindatasheet_V10_2018_12_04.csv"
...
# columns as factors
fcols <- c("domus_identifier","project_id", "primary_provenance_of_data", 
           "identifier_used_in_source_database",
           "alternative_museum_name_source","town_or_city",#"county",
           "postcode",
           "year_opened","year_opened_source",
           "year_closed","year_closed_source",
           "subject_matter","domus_subject_matter",
           "accreditation","accreditation_source",
           "governance", "governance_source", "size", 
           "year_museum_first_documented_source",
           "founder_source",
           "ace_size_designation", "ace_size_source",
           "aim_size_designation", "aim_size_source")
...
full_df$aim_size_designation <- as.character(full_df$aim_size_designation)
full_df$aim_size_designation[ full_df$aim_size_designation=="" ] <- "aim_unknown"
full_df$aim_size_designation = clean_sizes(full_df$aim_size_designation)
full_df$aim_size_designation <- as.factor(full_df$aim_size_designation)
summary(full_df$aim_size_designation)

full_df$ace_size_designation <- as.character(full_df$ace_size_designation)
full_df$ace_size_designation[ full_df$ace_size_designation=="" ] <- "ace_unknown"
full_df$ace_size_designation = clean_sizes(full_df$ace_size_designation)
full_df$ace_size_designation <- as.factor(full_df$ace_size_designation)
summary(full_df$ace_size_designation)
...
load_uk_dataset <- function( name ){
  ds = readRDS(paste0("../../049-SpatialDatasets/data/uk_data/",name))
  stopifnot( nrow(ds)>0 )
